defmodule IgIntranetWeb.ConnCase do
  @moduledoc """
  ...
  by setting `use IgIntranetWeb.ConnCase, async: true`, although
  ...
  using do
    quote do
      ...
      @endpoint IgIntranetWeb.Endpoint
  ...
  setup tags do
    IgIntranet.DataCase.setup_sandbox(tags)
  ...
  def log_in_user(conn, user) do
    token = IgIntranet.Accounts.generate_user_session_token(user)
